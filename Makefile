...
debug: hash_table_debug utility_debug crc32
	g++ -no-pie $(DEBUG_FLAGS) $(AVX_512_FLAGS) Src/main.cpp Obj/Logging.obj Obj/Swap.obj Obj/HashTable.obj Obj/HashCrc32.obj Obj/Utility.obj -o Exe/Run
fast: hash_table utility_fast crc32
	g++ -no-pie $(FAST_FLAGS) $(AVX_512_FLAGS) Src/main.cpp Obj/Logging.obj Obj/Swap.obj Obj/HashTable.obj Obj/HashCrc32.obj Obj/Utility.obj -o Exe/Run
